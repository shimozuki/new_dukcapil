            ...
            <div class="col-sm-3">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        @if ($document->status==config('constants.STATUS.REJECT'))
                        <div class="form-group">
                            <label>Pesan Kesalahan:</label>
                            <br /> <span class="label label-danger">{!! $document->pesan !!}</span>
                        </div>
                        @endif
                        <div class="form-group">
